      ...
      <div className="flex min-h-0 flex-1 items-stretch">
        <div className="relative hidden w-[60%] flex-col overflow-hidden md:flex bg-js-brand-primary">
          <div className="relative flex-1 px-10 py-8">
            ...
            >
              <p className="text-[10px] font-semibold uppercase tracking-wider text-js-brand-light">96% match</p>
              <p className="mt-1 text-sm font-semibold">AI Engineer · Example Co</p>
              <p className="mt-1 text-[11px] opacity-90">Strong match on Python, systems, and ML deployment.</p>
            </motion.div>
          </div>
        </div>
